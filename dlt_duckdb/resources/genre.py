...
# From 'genre movies' endpoint
@dlt.resource(name="genres_movies", write_disposition="replace")
def themoviedb_genres_movies_resource(api_secret_key: str = dlt.secrets.value):
