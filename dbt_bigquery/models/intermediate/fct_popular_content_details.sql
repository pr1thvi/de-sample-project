...
cte_movie_details AS (
    ...
    FROM {{ ref('stg_movie_details') }} smd
    LEFT JOIN cte_movie_reviews cmr ON smd._dlt_id = cmr._dlt_parent_id AND cmr.rank_review = 1
    LEFT JOIN cte_movie_similar cms ON smd._dlt_id = cms._dlt_parent_id AND cms.rank_similar = 1
),
